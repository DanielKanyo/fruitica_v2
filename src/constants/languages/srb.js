export const dataSrb = {
  data: {
    ...
    menuItems: [{
        title: "O nama",
        items: ["FRUITICA", "Naša misija", "Vesti", "Galerija", "Projekti"],
        subItems: ["BGA – Kupovina nove poljoprivredne mašine"],
      },
      {
        title: "Proizvodi",
        items: ["Potrošački proizvodi", "Poljoprivredna proizvodnja", "Sirovine za prehrambenu industriju"],
